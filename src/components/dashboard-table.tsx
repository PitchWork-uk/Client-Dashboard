  ...
  let columns: ColumnDef<TaskRow>[] = [
    ...
    },
    {
      ...
      sortingFn: (rowA, rowB, columnId) => {
        ...
        return (
          getStartDate(rowA.getValue(columnId)) -
          getStartDate(rowB.getValue(columnId))
        );
      },
      cell: ({ row }: { row: Row<TaskRow> }) => (
      ...
      ? [
          {
            ...
            cell: ({ row }: { row: Row<TaskRow> }) => {
              ...
              if (
                (status === "Completed" || status === "Client Review") &&
                deliverables &&
      ...
      ? [
          {
            ...
            cell: ({ row }: { row: Row<TaskRow> }) => {
              ...
              return (
                <ApproveTaskButton
                  taskId={
                    row.original.uniqueIdNumber?.toString() || row.original.id
                  }
